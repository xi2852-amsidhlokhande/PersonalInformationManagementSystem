...
public class AssetController {
	...
	public BaseResponse updateAssetById(@PathVariable Integer assetId,
			@RequestBody UpdateAssetRequest updateAssetRequest) {
		log.info("Received request to update Asset by assetId {} and asset details {}", assetId,
				gson.toJson(updateAssetRequest));
	...
	public BaseResponse deleteAssetById(@PathVariable Integer assetId) {
		...
		return BaseResponse.builder().data(String.format("Asset with assetId %d deleted successfully", assetId))
				.build();
	}
