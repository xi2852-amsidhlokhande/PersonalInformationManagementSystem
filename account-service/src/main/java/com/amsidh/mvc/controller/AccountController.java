...
public class AccountController {
	...
	public BaseResponse updateAccount(@PathVariable Integer accountId,
			@RequestBody UpdateAccountRequest updateAccountRequest) {
		log.info("Request received for update account with accountId {} and account", accountId,
	...
	public BaseResponse deleteAccount(@PathVariable Integer accountId) {
		...
		return BaseResponse.builder().data(String.format("Account with accountId %d deleted successfully", accountId))
				.build();
	}
