...
public class AccountServiceImpl implements AccountService {
	...
	public AccountResponse saveAccount(AccountRequest accountRequest) {
		...
		return objectMapper.convertValue(
				accountRepository.save(objectMapper.convertValue(accountRequest, Account.class)),
	...
	public AccountResponse updateAccount(Integer accountId, UpdateAccountRequest updateAccountRequest) {
		...
		}).orElseThrow(() -> new AccountDataNotFoundException(
				String.format("Account with accountId %d not found", accountId)));
